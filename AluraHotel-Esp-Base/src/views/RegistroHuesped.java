...
public class RegistroHuesped extends JFrame {
	...
	public RegistroHuesped(int idReserva) {
		...
		String idR = String.valueOf(idReserva);
		txtNreserva.setText(idR);
	...
	private void guardarHuesped() {
		if(txtFechaN.getDate() != null && !txtNombre.equals("") && !txtApellido.equals("") && !txtTelefono.equals("")) {
			LocalDate fechaNa = LocalDate.parse(((JTextField)txtFechaN.getDateEditor().getUiComponent()).getText());
			int numReserva = Integer.parseInt(txtNreserva.getText());
			Huespedes huespedes = new Huespedes(txtNombre.getText(), txtApellido.getText(), fechaNa, txtNacionalidad.getSelectedItem().toString(), txtTelefono.getText(), numReserva);
