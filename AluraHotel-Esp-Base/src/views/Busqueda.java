		...
		btnEditar.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				...
				if(filaReserva >= 0) {
					...
					System.out.println("linea 278 error");
				}
			}
		});
...
//				HuespedesTable();
	...
	private void ReservasTableId() {
//		modelo.setRowCount(0);
		List<Reserva> reservas = this.reservaController.buscar(txtBuscar.getText().toString());
	...
	public void modificarReserva() {
		Optional.ofNullable(modelo.getValueAt(tbReservas.getSelectedRow(), tbReservas.getSelectedColumn()))
			.ifPresent(fila -> {
				...
				String precio = (String) modelo.getValueAt(tbReservas.getSelectedRow(), 3);
				String formaPago = (String) modelo.getValueAt(tbReservas.getSelectedRow(), 4);
				this.reservaController.modificar(id, fechaE, fechaS, precio, formaPago);
				
				JOptionPane.showMessageDialog(this, "Reserva modificada con exito!");
			});
	}
	
	public String nuevoPrecio(LocalDate fechaE, LocalDate fechaS) {
		if(fechaE != null && fechaS != null) {
			int dias = (int) ChronoUnit.DAYS.between(fechaE, fechaS);
			int precio = 40;
			int total = dias * precio;
	...
	public void eliminar() {
		if(tbReservas.getSelectedRowCount() == 0 || tbReservas.getSelectedColumnCount() == 0 || 
			...
			JOptionPane.showMessageDialog(this, "Elija el elemento a eliminar");
			return;
		}
		if(tbReservas.getSelectedRowCount() > 0 || tbReservas.getSelectedColumnCount() > 0) {
			Optional.ofNullable(modelo.getValueAt(tbReservas.getSelectedRow(), tbReservas.getSelectedColumn()))
