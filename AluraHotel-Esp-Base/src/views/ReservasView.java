...
public class ReservasView extends JFrame {
	...
	public void calcularPrecio(JDateChooser fechaE, JDateChooser fechaS) {
		if(fechaE.getDate() != null && fechaS.getDate() != null) {
			if(fechaE.getDate().after(fechaS.getDate())) {
				JOptionPane.showMessageDialog(null, "La fecha de entrada es incorrecta", "Date Error", JOptionPane.ERROR_MESSAGE);
				return;
			}
